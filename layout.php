...
<body class="<?= isset($pageTitle) && ($pageTitle === 'Fin de partie' ? 'vikings' : ($pageTitle === 'Fin de partie GOT' ? 'got' : '')) ?>">
    <header class="main-header">
        <div>
            <nav class="main-nav">
                <a href="/memory">Accueil</a>
                <a href="/memory/top10">Top 10</a>
                <a href="/memory/profil">Profil</a>
            </nav>
        </div>
    </header>
